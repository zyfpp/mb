...
#$ -l h_rt=48:0:0
#$ -l mem=5G
#$ -wd /home/zczl463/Scratch/mb/prokkaout
#$ -pe smp 12
...
acc_list="/home/zczl463/Scratch/mb/prokkarunning/acc_list.txt"
cat $acc_list| xargs -P10 -I'{}' sh /home/zczl463/Scratch/mb/prokkarunning/paraprokka.sh "${input_dir}/{}"
